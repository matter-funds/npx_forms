...
data_dir:pwd,"/../../data/";
parsed_npx_paths:system"ls ",data_dir,"/npx_forms_parsed/iShares_Trust/*/iShares_Core_S\\&P_500_ETF";
parsed_npx_paths:{x where not x like"*.csv"}parsed_npx_paths;
ps:get each hsym`$parsed_npx_paths;
tokens:{"_"sv 2#reverse"-"vs @[;1]reverse"/"vs x}each parsed_npx_paths
